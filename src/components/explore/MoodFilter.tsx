...
interface MoodFilterProps {
  ...
  onSelectMood: (moodId: number | null) => void;
}

interface FilterItemProps {
  item: MoodFilterItem;
  isSelected: boolean;
  onPress: (item: MoodFilterItem) => void;
}
  ...
  return (
    <View style={styles.container}>
      <LegendList
        ...
        renderItem={({ item }) => {
          const isSelected =
            selectedMood === null ? item.id === 0 : selectedMood === item.id;
