...
import { tattooBlurHashes, getTattooBlurHash } from './blurhash-code';
 ...
 */
export function useTattooBlurHash(tattooId: number, type: 'cover' | 'gallery' = 'cover', galleryIndex?: number) {
